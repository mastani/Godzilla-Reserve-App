package ir.mastani.godzilla.api.volley;
...
public class NetImageView extends ImageView {
     ...
     * {@link NetImageView#setDefaultImageResId(int)} on the view.
     * <p>
     * NOTE: If applicable, {@link NetImageView#setDefaultImageResId(int)}
     * and {@link NetImageView#setErrorImageResId(int)} should be called
